...
package body StuffList is
   ...
   function Count_Elements (L : in List) return Integer is
   ...
   function Allocate (X : StuffList.Element_Pointer; P : Position)
                                              return Position;
   ...
   procedure AddToRear (L : in out List; X : StuffList.Element_Pointer) is
   ...
   procedure Swap (L : in out List;
      ...
      X_Pointer : StuffList.Element_Pointer;
   begin
   ...
   function Retrieve (L : in List; P : in Position)
                              return StuffList.Element_Pointer is
   begin
      if IsEmpty (L) then
         raise EmptyList;
